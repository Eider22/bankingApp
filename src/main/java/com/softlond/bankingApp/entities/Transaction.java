...
public class Transaction {
	...
	public Transaction(LocalDate date, LocalTime hour, String transactionType, Double amount, String idAccount,
	...
	public Transaction(String id, LocalDate date, LocalTime hour, String transactionType, Double amount,
